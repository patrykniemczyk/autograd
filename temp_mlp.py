...
class Neuron:
    ...
    def __init__(self, input_size: int, initialization_gain: float = 2.0) -> None:
        ...
        if initialization_gain <= 0:
            raise ValueError(f"initialization_gain must be positive, got {initialization_gain}")
...
class Linear:
    ...
    def __init__(self, input_size: int, output_size: int, 
                 initialization_gain: float = 2.0) -> None:
        """
        ...
        self.neurons = [Neuron(input_size, initialization_gain) 
...
class MLP:
    ...
    def __init__(self, input_size: int, hidden_sizes: List[int], output_size: int,
                 activation: ActivationType = 'relu') -> None:
        """
